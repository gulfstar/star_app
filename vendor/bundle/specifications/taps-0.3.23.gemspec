...
Gem::Specification.new do |s|
  ...
  s.files = ["bin/schema", "bin/schema.cmd", "bin/taps", "lib/taps/chunksize.rb", "lib/taps/cli.rb", "lib/taps/config.rb", "lib/taps/data_stream.rb", "lib/taps/db_session.rb", "lib/taps/errors.rb", "lib/taps/log.rb", "lib/taps/monkey.rb", "lib/taps/multipart.rb", "lib/taps/operation.rb", "lib/taps/progress_bar.rb", "lib/taps/schema.rb", "lib/taps/server.rb", "lib/taps/utils.rb", "lib/taps/version.rb", "lib/vendor/okjson.rb", "README.rdoc", "spec/base.rb", "spec/chunksize_spec.rb", "spec/cli_spec.rb", "spec/data_stream_spec.rb", "spec/operation_spec.rb", "spec/server_spec.rb", "spec/utils_spec.rb", "VERSION.yml"]
